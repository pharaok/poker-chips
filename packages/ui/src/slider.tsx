...
export default function Slider<T extends number>({
  ...
  return (
    <RASlider {...props} className={twMerge("w-full", className)}>
      <SliderTrack className="relative h-2 before:absolute before:top-[50%] before:block before:h-1 before:w-full before:-translate-y-[50%] before:rounded-full before:bg-gray-800 before:content-['']">
